...
<div class="container">
    ...
    <div class="stats-row">
        <div class="stat-card">
            ...
            <p class="stat-label">Total latihan soal</p>
        </div>
        <div class="stat-card">
    ...
    <div class="table-container">
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('exam.show', $exam->slug) }}" class="btn-modern btn-detail">
        ...
        <div class="empty-state">
            ...
            <h3>Belum ada latihan soal</h3>
            <p>Mulai dengan membuat latihan soal pertama Anda</p>
            <a href="{{ route('exam.create') }}" class="btn-create" style="margin-top: 20px;">
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                </svg>
                Buat latihan soal Pertama
            </a>
        </div>
        @endif
    </div>
